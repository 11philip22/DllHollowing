...
int main()
{
	...
	hProcess = OpenProcess(PROCESS_ALL_ACCESS, FALSE, 21316);

	pvRemoteBuffer = VirtualAllocEx(hProcess, NULL, sizeof cModuleToInject, MEM_COMMIT, PAGE_READWRITE);
	...
	HANDLE dllThread = CreateRemoteThread(hProcess, NULL, 0, threadRoutine, pvRemoteBuffer, 0, NULL);
	...
	ReadProcessMemory(hProcess, hRemoteModule, targetProcessHeaderBuffer, headerBufferSize, NULL);
